...
需求分析 & Markdown(可以在线协作) 或 asciidoc\\
\hline
技术分析 & Markdown(可以在线协作) 或 asciidoc\\
\hline
\rowcolor[rgb]{0.0, 0.9, 0.8}
规划分析(思维导图，规划系统和行动全景图) & Markdown 或 asciidoc\\
\hline
测试计划 & Markdown(可以在线协作) 或 asciidoc\\
\hline
\end{tabular}
\end{table}
}
...
\hline
\rowcolor[rgb]{0.0, 0.9, 0.8}
甘特图/燃尽图 & LaTex/Markdown/asciidoc\\
\hline
用例图 & LaTex/Markdown/asciidoc\\
\hline
\rowcolor[rgb]{0.0, 0.9, 0.8}
类图 & LaTex/Markdown/asciidoc\\
\hline
顺序协作图 & LaTex/Markdown/asciidoc\\
\hline
\rowcolor[rgb]{0.0, 0.9, 0.8}
其他图(如状态机，数据流，流程等) & LaTex/Markdown/asciidoc\\
\hline
\end{tabular}
\end{table}
}
