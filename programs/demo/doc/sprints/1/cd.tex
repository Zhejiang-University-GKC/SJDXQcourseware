...
\begin{tikzpicture}
\begin{class}{TwoStrings}{0,0}
\attribute{- m\_s1 : string}
\attribute{- m\_s2 : string}
\operation{+ get\_S1() : string}
\operation{+ get\_S2() : string}
\operation{+ set\_S1() : void}
\operation{+ set\_S2() : void}
\end{class}
\begin{class}{TwoStringParameter}{0,-5}\end{class}
\end{tikzpicture}
\newpage
...
\operation{+ set\_QueryCommand() : void}
...
\operation{+ set\_x() : void}
\operation{+ get\_x() : double}
\operation{+ set\_y() : void}
...
\begin{class}{BusDataModel}{10,0}\end{class}
\end{tikzpicture}
\end{document}
