...
\operation{+ Exec() : void}
\end{class}
\begin{class}{IPropertyNotification}{8,-12}\end{class}
\begin{class}[text width=6cm]{BusViewModelSink}{8,-8}
...
\end{class}
\begin{class}[text width=6cm]{BusLabel}{0,-5}
\inherit{CWindowImpl}
...
\begin{tikzpicture}
\begin{class}{IStateBase}{4,-13}\end{class}
\begin{class}[text width=4cm]{StartState}{-1,-16}
\inherit{IStateBase}
\operation{+ Process(uEvent:int, param:any) : int}
\end{class}
\begin{class}[text width=4cm]{PopupState}{4,-16}
\inherit{IStateBase}
\operation{+ Process(uEvent:int, param:any) : int}
\end{class}
\begin{class}[text width=4cm]{CaptureState}{9,-16}
\inherit{IStateBase}
\operation{+ Process(uEvent:int, param:any) : int}
\end{class}
\begin{class}{CWindowImpl}{9,-2}
\end{class}
\begin{class}[text width=10cm]{MainWindow}{0,0}
\inherit{CWindowImpl}
...
\begin{class}[text width=6cm]{MainWindowPropertySink}{-2,-8}
\inherit{IPropertyNotification}
\attribute{- m\_pW : MainWindow}
\operation{+ OnPropertyChanged(str:string) : void}
\end{class}
\begin{class}{ICommandNotification}{6,-11}\end{class}
\begin{class}[text width=8cm]{MainWindowCommandSink}{6,-8}
...
\end{class}
\composition{BusApp}{1..*}{m\_spViewModel}{BusViewModel}
